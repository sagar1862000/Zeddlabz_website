...
import img7 from "../../assets/AutoMotive/img7.svg";
...
const Card9 = () => {
  ...
  return (
    <div className="flex  place-content-center sm:flex-col md:flex-row font-lato w-screen bg-slate-900 ">
      <div className="sm:w-[90%] md:w-[70%] flex flex-wrap ml-6  flex-col py-12">
      ...
      <div className="flex place-content-center my-auto">
        <img srcSet={img7} className="mx-6 h-[450px] " />
      </div>
    </div>
  );
};
