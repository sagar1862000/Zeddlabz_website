...
import img4 from "../../assets/Consumer/img4.svg";
...
const Card4 = () => {
  ...
  return (
    <div className="flex flex-col font-medium"  style={{ backgroundImage: `url(${img4})` }}>
      <div className="flex z-10 flex-col items-center py-[30px] w-full min-h-[638px] max-md:max-w-full">
      <div className=" text-white py-16 text-31xl font-bold font-Poppins" >Read the Articles</div>
