...
const Card5 = () => {
  ...
  return (
    <div className="flex flex-col w-screen bg-slate-900 font-lato">
      <div className="w-[50%] text-13xl my-12 mx-auto font-extrabold text-center text-white ">How we Help Our Client</div>
      <div className="flex gap-6 sm:flex-col w-[85%] mx-auto py-4 md:flex-row">
        {cards.map((card, index) => (
          ...
          >
            ...
            <div className="pr-2 text-white">{card.discription}</div>
          </div>
        ))}
      </div>
    </div>
