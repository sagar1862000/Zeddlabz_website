...
const Card7 = () => {
    const NewsArticals = [
      ...
      return (
        <div className="flex flex-col py-[80px] bg-slate-900 ">
          <div className="flex justify-between items-center w-full px-9 ">
            <div className="self-stretch my-auto font-Poppins text-4xl font-bold leading-none text-white">
              Related News
            </div>
              ...
              >
                <div className="flex flex-col w-full text-lg text-center max-w-[592px] max-md:max-w-full">
                  ...
                  <div className="flex flex-col text-left mt-5 max-w-full w-[567px]">
                    <div className="text-5xl font-Poppins font-bold leading-10 text-white max-md:max-w-full">
                      {Artical.Title}
                    </div>
                    <div className="flex flex-col font-inter mt-3.5 w-full text-mini">
                      <div className="leading-7  text-white max-md:max-w-full">
                        {Artical.Description}
                      </div>
